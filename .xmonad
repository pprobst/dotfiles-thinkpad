...
Config {
    ...
    sepChar = "%",
    alignSep = "**",
    template = "%StdinReader% ** %volumelevel% %bat% %cpu% %coretemp% %memory% %wlp3s0wi% <fc=#694B69>[</fc> <fc=#C6AFC7>%date%</fc> <fc=#694B69>]</fc> %getRedshift%"
}
